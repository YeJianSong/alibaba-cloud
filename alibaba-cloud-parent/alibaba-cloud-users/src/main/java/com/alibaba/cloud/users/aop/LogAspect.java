package com.alibaba.cloud.users.aop;
...
public class LogAspect {
     ...
     */
    private final String POINTCUT = "execution(* com.alibaba.cloud.users.controller..*(..))";
    ...
    public void doAfter(JoinPoint joinPoint) {
        log.info("Logger-->后置通知，方法名：{}",joinPoint.getSignature().getName());
    }
