...
public class MessageController {
    ...
    /**
     * 测试推送消息到没有配置交换机(这个交换机是没有创建没有配置的)，消息推送失败
     * @return
     */
    ...
    public String TestMessageAck() {
        ...
        return "send TestMessageAck1 ok";
    }
    ...
    public String TestMessageAck2() {
        ...
        return "send TestMessageAck2 ok";
    }
}
